...
const dict: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    'genres.form.label.time':        'デフォルト通知時間（任意）',
    'genres.form.placeholder.name':  'ジャンル名を入力',
    ...
    'genres.form.error.colorFetch':  'カラーデータの取得に失敗しました',
    'genres.form.error.genreFetch':  'ジャンルデータの取得に失敗しました',
    'genres.form.error.notFound':    'ジャンルが見つかりませんでした',
    'genres.form.error.updateFail':  '更新に失敗しました',
    'genres.form.error.createFail':  '作成に失敗しました',
    ...
    'admin.users.fetchError':     'ユーザーを取得できませんでした',
    ...
    'admin.group.form.membersLabel':             'メンバーを選択（最低1人）',
    'admin.group.form.hint':                     '※ グループ未所属のユーザーのみ表示されます',
    ...
    'admin.group.form.error.groupUserRequired':  'グループには1人以上のユーザーが必要です',
  ...
  en: {
    ...
    'schedule.memo.title':         'Detail Memo',
    ...
    'genres.form.label.time':        'Default notification time (optional)',
    'genres.form.placeholder.name':  'Enter genre name',
    ...
    'genres.form.error.colorFetch':  'Failed to load color data',
    'genres.form.error.genreFetch':  'Failed to load genre data',
    'genres.form.error.notFound':    'Genre not found',
    'genres.form.error.updateFail':  'Failed to update',
    'genres.form.error.createFail':  'Failed to create',
    ...
    'admin.users.fetchError':     'Failed to load users',
    ...
    'admin.group.form.membersLabel':             'Select members (at least 1)',
    'admin.group.form.hint':                     '* Only ungrouped users are shown',
    ...
    'admin.group.form.error.groupUserRequired':  'Group must have at least one user',
